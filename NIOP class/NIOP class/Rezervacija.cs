...
namespace NIOP_class
{
    internal class Rezervacija : IComparable
    {
        ...
        public Rezervacija(string imeGosta, DateTime checkIn, DateTime checkOut, int brojGostiju, int brojRezervacije, Soba soba)
        {
        ...
        public override string ToString()=> this.ImeGosta + ' ' + this.checkIn.ToString() + ',' + this.Soba.BrojSobe;
